...
//
//      Minimal number of CBNL word are used for storing,
//      but no less then one word:
...
//      be greater then number of occupied words as this is necessary
...
//      Note that array may reserve more words than it is required.
//
//      If macro NCHECKPTR is defined, method checkexpand() increases
//      number of available words uo to number of actually reserved
